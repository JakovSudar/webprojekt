package com.tasks.security.oauth2;
...
import com.tasks.exception.OAuth2AuthenticationProcessingException;
import com.tasks.model.AuthProvider;
import com.tasks.security.UserPrincipal;
import com.tasks.security.oauth2.user.OAuth2UserInfo;
import com.tasks.security.oauth2.user.OAuth2UserInfoFactory;
...
public class CustomOAuth2UserService extends DefaultOAuth2UserService {
    ...
    private User registerNewUser(OAuth2UserRequest oAuth2UserRequest, OAuth2UserInfo oAuth2UserInfo) {
        ...
        user.setProviderIdString(oAuth2UserInfo.getId());
    ...
    private User updateExistingUser(User existingUser, OAuth2UserInfo oAuth2UserInfo,OAuth2UserRequest oAuth2UserRequest) {
        ...
        existingUser.setProviderIdString(oAuth2UserInfo.getId());
        existingUser.setOznAkt(1);
